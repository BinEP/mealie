...
| VIDEO_IMPORT_DOMAINS                              | ["youtube.com", "youtu.be", "tiktok.com", "instagram.com"] | Comma-separated list of domains that should automatically use video import flow when using the URL import endpoint. Example: `youtube.com,youtu.be,tiktok.com,instagram.com`. URLs from these domains will be processed as videos instead of web scraping                                                          |
